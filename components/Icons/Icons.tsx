...
export const ArkcomLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <rect width="64" height="64" rx="8" fill="#BCC5D1"/>
    <defs>
      <clipPath id="logoClip">
        <rect width="64" height="64" rx="8"/>
      </clipPath>
      <clipPath id="smallCircleClip">
        <path d="M24 10 A 14 14 0 0 1 24 38 Z" />
      </clipPath>
      <mask id="cutoutMask">
    ...
    <g clipPath="url(#logoClip)">
      <g mask="url(#cutoutMask)">
        <circle cx="64" cy="64" r="58" stroke="#3A465B" strokeWidth="3"/>
        <circle cx="64" cy="64" r="50" stroke="#3A465B" strokeWidth="3"/>
        <circle cx="64" cy="64" r="42" stroke="#3A465B" strokeWidth="3"/>
        <circle cx="64" cy="64" r="34" stroke="#3A465B" strokeWidth="3"/>
        <circle cx="64" cy="64" r="26" stroke="#3A465B" strokeWidth="3"/>
        <circle cx="64" cy="64" r="18" stroke="#3A465B" strokeWidth="3"/>
        <circle cx="64" cy="64" r="10" stroke="#3A465B" strokeWidth="3"/>
      </g>
      <g clipPath="url(#smallCircleClip)">
        <circle cx="24" cy="24" r="12" stroke="#3A465B" strokeWidth="3"/>
        <circle cx="24" cy="24" r="6" stroke="#3A465B" strokeWidth="3"/>
      </g>
    </g>
  </svg>
);
...
export const WandIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="m21.64 3.64-1.28-1.28a1.21 1.21 0 0 0-1.72 0L2 18.12V22h3.88l14.76-14.76a1.21 1.21 0 0 0 0-1.72Z" /><path d="m14 7 3 3" /><path d="M5 6v4" /><path d="M19 14v4" /><path d="M10 2v2" /><path d="M7 8H3" /><path d="M21 16h-4" /><path d="M11 3H9" />
    </svg>
);
...
export const SendIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" height="24" width="24" {...props}>
...
export const SpacesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const LinearIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M7 19.5a2.5 2.5 0 0 1-5 0V4.5a2.5 2.5 0 0 1 5 0v15Z" /><path d="M17 19.5a2.5 2.5 0 0 1-5 0V4.5a2.5 2.5 0 0 1 5 0v15Z" /><path d="M22 12a2.5 2.5 0 0 1-5 0V4.5a2.5 2.5 0 0 1 5 0v7.5Z" /></svg>
);

export const NotionIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /><path d="M12 2v20" /><path d="M8 12H4" /><path d="M12 12h8" /><path d="M10 4v2" /><path d="M10 18v2" /></svg>
);
...
export const LightbulbIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15.09 16.05A6.47 6.47 0 0 1 12 21.5a6.47 6.47 0 0 1-3.09-5.45c0-2.88 1.83-5.24 4.09-8.49.1-.14.24-.26.4-.35.17-.1.35-.15.54-.15s.37.05.54.15c.16.09.3.21.4.35 2.26 3.25 4.09 5.61 4.09 8.49Z"/><path d="M12 2v4"/><path d="M12 21.5v-2.5"/><path d="M6.22 6.22l2.12 2.12"/><path d="M15.66 15.66l2.12 2.12"/><path d="m2 12 h4"/><path d="m18 12 h4"/><path d="M6.22 17.78l2.12-2.12"/><path d="M15.66 8.34l2.12-2.12"/></svg>
);
...
export const ArrowUpIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 5v14"/><path d="m18 11-6-6-6 6"/></svg>
);

export const ArrowDownIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 5v14"/><path d="m18 19-6 6-6-6"/></svg>
);
